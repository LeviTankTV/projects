...
public abstract class Axe extends Weapon {
    public Axe(String name, String description, int value, int attackPower, int critChance, int critMultiplier) {
    ...
    public void applySpecialEffect(Entity target) {
        // Axes don't have a special effect, but you could override this in specific subclasses
    }
}
