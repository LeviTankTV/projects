...
public abstract class Staff extends Weapon {
    public Staff(String name, String description, int value, int attackPower, int critChance, int critMultiplier) {
    ...
    public void applySpecialEffect(Entity target) {
        // Staves don't have a special effect, but you could override this in specific subclasses
    }
}
